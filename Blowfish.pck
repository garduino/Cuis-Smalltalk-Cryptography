'From Cuis 4.0 of 21 April 2012 [latest update: #1267] on 30 April 2012 at 7:46:15 pm'!
...
!Blowfish class methodsFor: 'decrypt' stamp: 'PaulDeBruicker 4/26/2011 18:42'!
decrypt: someData with: aKeyByteArray"use this when you have a wordArray"	^self new decrypt: someData with: aKeyByteArray.! !

!Blowfish class methodsFor: 'decrypt' stamp: 'PaulDeBruicker 4/25/2011 13:40'!
...
!Blowfish class methodsFor: 'encrypt' stamp: 'PaulDeBruicker 4/26/2011 18:41'!
...
!Blowfish class methodsFor: 'encrypt' stamp: 'PaulDeBruicker 4/26/2011 18:42'!
encrypt: someData with: aKey"use this when you have a wordArray"	^self new encrypt: someData  with: aKey.! !

!Blowfish class methodsFor: 'encrypt' stamp: 'PaulDeBruicker 4/26/2011 18:56'!
